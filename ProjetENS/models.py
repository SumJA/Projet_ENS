...
class Alignment(models.Model):
    ...
    gene_family_idgene_family = models.ForeignKey('GeneFamily', models.DO_NOTHING,
                                                  db_column='gene_family_idgene_family')
...
class Species(models.Model):
    ...
    species_taxid = models.CharField(db_column='Species_Taxid', unique=True, max_length=45, blank=True,
                                     null=True)  # Field name made lowercase.
    assembly_name = models.CharField(db_column='Assembly_name', max_length=45, blank=True,
                                     null=True)  # Field name made lowercase.
    assembly_source = models.CharField(db_column='Assembly_source', max_length=45, blank=True,
                                       null=True)  # Field name made lowercase.
    species_classification = models.TextField(db_column='Species_Classification', blank=True,
                                              null=True)  # Field name made lowercase.
...
class Genes(models.Model):
    ...
    gene_family_idgene_family1 = models.ForeignKey(GeneFamily, models.DO_NOTHING,
                                                   db_column='gene_family_idgene_family1')
...
class AlignedSequence(models.Model):
    ...
    alignment_idalignment = models.ForeignKey(Alignment, models.DO_NOTHING,
                                              db_column='Alignment_idAlignment')  # Field name made lowercase.
...
class GeneHasExpression(models.Model):
    ...
    expressionlevel_idexpressionlevel = models.ForeignKey(Expressionlevel, on_delete=models.CASCADE,
                                                          db_column='expressionlevel_idexpressionlevel')
    expression_method_idexpression_method = models.ForeignKey(ExpressionMethod, on_delete=models.CASCADE,
                                                              db_column='expression_method_idexpression_method')
    conditions_idconditions = models.ForeignKey(Conditions, on_delete=models.CASCADE,
                                                db_column='conditions_idconditions')
    organs_idorgans = models.ForeignKey('Organs', on_delete=models.CASCADE, db_column='organs_idorgans')

    class Meta:
        managed = False
        db_table = 'gene_has_expression'
        unique_together = (('idgene_has_expressioncol', 'genes_idgenes', 'expressionlevel_idexpressionlevel',
                            'expression_method_idexpression_method', 'conditions_idconditions', 'organs_idorgans'),)
